import  { IRequest } from '../const'
const requestsPerTab: Map<number, Map<string, Partial<IRequest>>> = new Map()
...
// browser begins sending the request
